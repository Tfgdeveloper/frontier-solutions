    ...
    <div ref={ref} className="relative flex gap-8 md:gap-8 pb-12 last:pb-0">
      ...
      <div className="flex flex-col items-center">
        <motion.div
          ...
          className="relative z-10 w-4 h-4 md:w-6 md:h-6 rounded-full border-2 bg-[#000] flex items-center justify-center"
        >
          {isDone ? (
      ...
      <motion.div
        ...
        className={`relative w-full p-8 md:p-8 rounded-[30px] border overflow-hidden transition-colors duration-700 ${
          isInView
            ? "bg-[#000]/30 border-[#F06A22] shadow-[0_0_40px_rgba(240,106,34,0.1)]"
...
export default function ProcessTimeline2() {
